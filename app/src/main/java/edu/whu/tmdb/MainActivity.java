...
import edu.whu.tmdb.map.MapActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    Transaction trans = Transaction.getInstance(this);
    //Node node;
    ...
    public MainActivity() throws IOException, TMDBException, JSQLParserException {
    }
