...
public class ShowSwi extends AppCompatActivity implements Serializable {
    ...
    private void showSwiTab(SwitchingTable switchingT) {
        int tabCol = 7;
        int tabH = switchingT.switchingTableList.size();
        ...
        for (int i = 0; i <= tabH; i++) {
            ...
            if (i == 0) {
                ...
                stemp1 = String.valueOf(switchingT.switchingTableList.get(i - 1).oriId);
                stemp2 = String.valueOf(switchingT.switchingTableList.get(i - 1).oriAttrid);
                stemp3 = String.valueOf(switchingT.switchingTableList.get(i - 1).oriAttr);
                stemp4 = String.valueOf(switchingT.switchingTableList.get(i - 1).deputyId);
                stemp5 = String.valueOf(switchingT.switchingTableList.get(i - 1).deputyAttrId);
                stemp6 = String.valueOf(switchingT.switchingTableList.get(i - 1).deputyAttr);
                stemp7 = switchingT.switchingTableList.get(i - 1).rule;
            }
