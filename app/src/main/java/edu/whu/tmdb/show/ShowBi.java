...
public class ShowBi extends AppCompatActivity implements Serializable {
    ...
    private void showBiTab(BiPointerTable biPointerT){
        ...
        int tabCol  = 4;
        int tabH = biPointerT.biPointerTableList.size();
        ...
        for(int i = 0; i <= tabH; i++){
            ...
            if(i == 0){
                ...
                oj1 = biPointerT.biPointerTableList.get(i-1).classid;
                oj2 = biPointerT.biPointerTableList.get(i-1).objectid;
                oj3 = biPointerT.biPointerTableList.get(i-1).deputyid;
                oj4 = biPointerT.biPointerTableList.get(i-1).deputyobjectid;
                stemp1 = oj1.toString();
                stemp2 = oj2.toString();
                stemp3 = oj3.toString();
                stemp4 = oj4.toString();
