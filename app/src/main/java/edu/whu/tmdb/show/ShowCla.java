...
public class ShowCla extends AppCompatActivity implements Serializable {
    ...
    private void showClaTab(ClassTable classT) {
        int tabCol = 7;
        int tabH = classT.classTableList.size();
        ...
        for (int i = 0; i <= tabH; i++) {
            ...
            if (i == 0) {
                ...
                oj1 = classT.classTableList.get(i-1).classname;
                oj2 = classT.classTableList.get(i-1).classid;
                oj3 = classT.classTableList.get(i-1).attrnum;
                oj4 = classT.classTableList.get(i-1).attrid;
                oj5 = classT.classTableList.get(i-1).attrname;
                oj6 = classT.classTableList.get(i-1).attrtype;
                oj7 = classT.classTableList.get(i-1).classtype;
                stemp1 = oj1.toString();
                stemp2 = oj2.toString();
                stemp3 = oj3.toString();
                stemp4 = oj4.toString();
